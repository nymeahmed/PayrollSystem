...
<html>
<head>
	<title>Update email of HR</title>
</head>
<body>
	<form method="post" action="upemailhr.php" >
		<center><fieldset>
		<legend><h1><i>Update Email Address of HR</i></h1></legend>
		<table>
                <tr>
            ...
            <td><input type="submit" name="save" value="Save"> <br>
	</form>
...
<?php 
	...
	elseif (isset($_POST['save'])) {
        ...
        if(mysqli_num_rows($ver) == 1){
			$email = $_POST['email'];
			$sql = "UPDATE hr SET email ='$email' WHERE username = '$name'";
